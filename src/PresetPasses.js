...
function PresetPasses() {}

PresetPasses.Brighten = function (amount) {
...
PresetPasses.blurStackBox = function(radius) {
  ...
  this.render = function(imageData, ctx) {
...
window.PresetPasses = PresetPasses;
